...
echo "🚀 OpenSearch React UI - Available Commands"
echo "==========================================="
echo ""
...
echo "  npm run generate-catalog        # Generate 1000 product catalog"
echo "  npm run generate-catalog 500    # Generate custom number of products"
...
echo "  npm run test-search             # Test search functionality"
echo ""
...
echo "• React App:      http://localhost:3000 (dev) or custom port (prod)"
echo ""
echo "📚 Prerequisites:"
echo "=================="
echo "• Node.js 16+ (current: $(node --version 2>/dev/null || echo 'not installed'))"
echo "• npm (current: $(npm --version 2>/dev/null || echo 'not installed'))"
echo "• OpenSearch running on localhost:30920"
echo "• curl for health checks"
echo ""
echo "🆘 Common Issues:"
echo "=================="
echo "• OpenSearch not running: Start OpenSearch on port 30920"
echo "• Port conflicts: Scripts will try alternative ports automatically"
echo "• Build fails: Run 'npm run clean:all' then 'npm install'"
echo "• Tests fail: Known issue with axios/Jest compatibility"
echo ""
...
echo ""
echo "💡 Tip: Use './build-and-run.sh' for the fastest complete setup!"
echo ""
